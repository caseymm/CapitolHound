...
from capitolHoundApp.forms import NotesSearchForm, UserForm, UserProfileForm, SaveThisSearchForm
from django.shortcuts import *


#from capitolHoundApp.query import NotesQuery
import urllib
...
def notes(request):
    ...
    return render(request, "capitolHoundApp/notes.html", context)
...
def note(request, pk):
    ...
    return render(request, "capitolHoundApp/note.html", context)
...
def archive(request):
    ...
    return render(request, "capitolHoundApp/archive.html", context)

#def note_list(request, pk):
#    note = get_object_or_404(Note, id=pk)
#    all_notes = Note.objects.all()
#    return render(request, "../capitolHound/templates/base.html", {'all_notes': all_notes})
...
def user_login(request):
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        return render_to_response('capitolHoundApp/login.html', {}, context)
...
def topics(request):
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        # No context variables to pass to the template system, hence the
        # blank dictionary object...
        return render_to_response('capitolHoundApp/email_success.html', {}, context)
    
    return render_to_response('capitolHoundApp/note.html', {}, context)
